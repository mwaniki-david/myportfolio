...
const Work = () => {
  return (
    <div id='Work' className='w-screen h-auto py-4 px-8 mt-12'>
      <div className='flex flex-col'>
        <div className=' flex items-center justify-center font-bold text-[45px] py-5 '>
          <h1 className='px-4 py-4 font-bold md:text-[45px] text-[40px] uppercase'>
            Projects.
          </h1>
        </div>
        <div className='grid md:grid-flow-col  py-4 px-6 gap-5'>
          <div className='px-6 py-5  max-width-[250px] '>
            ...
            <div className='relative  -top-4 items-center justify-center flex  px-5 py-6 shadow-lg shadow-white border border-white rounded-2xl max-w-[320px] '>
